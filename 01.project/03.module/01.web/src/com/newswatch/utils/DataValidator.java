...
public class DataValidator {
	...
	public static final void checkNumber(String str){
		AssertUtils.isTrue(isNumber(str),"'"+str+"' must be a Number format here.");
	}
	...
	public static final void checkNumberNotNullOrZero(Number number){
		AssertUtils.isTrue(isNumberNotNullOrZero(number),"Number must not be null or zero.");
	}
	...
	public static final void checkShortDateStr(String aDateStr){
		AssertUtils.isTrue(isShortDateStr(aDateStr),"The str-'"+aDateStr+"' must match 'yyyy-MM-dd' format.");
	}
	...
	public static final void checkLongDateStr(String aDateStr){
		AssertUtils.isTrue(isLongDateStr(aDateStr),"The str-'"+aDateStr+"' must match 'yyyy-MM-dd HH:mm:ss' format.");
	}
	...
	public static final void checkMailDateStr(String aDateStr){
		AssertUtils.isTrue(isMailDateStr(aDateStr),"The str-'"+aDateStr+"' must match 'yyyyMMddHHmmss' format.");
	}
